...
wget http://jenkins.int.xcalar.com/job/BuildSqldf/${ITER}/artifact/build/amzn1/xcalar-sqldf-0.2-${ITER}.amzn1.noarch.rpm
$XLRDIR/bin/reposync.sh amzn1-repo xcalar-sqldf-0.2-${ITER}.amzn1.noarch.rpm
