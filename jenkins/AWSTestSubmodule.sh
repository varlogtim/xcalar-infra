...
do_build () {
    git submodule add https://git-codecommit.us-west-2.amazonaws.com/v1/repos/xcalar-idl
    git submodule sync
    git config -f .gitmodules submodule.xcalar-idl.url https://git-codecommit.us-west-2.amazonaws.com/v1/repos/xcalar-idl
