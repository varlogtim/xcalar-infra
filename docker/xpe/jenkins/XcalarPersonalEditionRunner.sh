...
XDEE_BUILD_TARGET_DIR="xcalar-desktop-edition" # name of xcalar-gui build dir generated by grunt --product=XDEE
...
buildXcalarGuiForApp() {
    ...
    if [ ! -d "$XDEE_GUI_BUILD_DIR" ]; then
        ...
        # --product=XDEE but specify branding in case
        node_modules/grunt/bin/grunt dev --product=XDEE --branding="$APP_NAME"
