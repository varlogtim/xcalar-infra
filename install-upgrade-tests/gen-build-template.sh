...
case "${CLOUD_PROVIDER}" in
    aws)
        ...
        DOCKER_INSTALL_MACHINE_TYPE=${DOCKER_INSTALL_MACHINE_TYPE:-i3.xlarge}
        TESTHOST_IMAGE=${TESTHOST_IMAGE:-ami-4185e621}
        TESTHOST_MACHINE_TYPE=${TESTHOST_MACHINE_TYPE:-i3.xlarge}
        TESTCLUSTER_IMAGE="${BUILD_CLUSTER_IMAGE}"
        TESTCLUSTER_MACHINE_TYPE=${TESTCLUSTER_MACHINE_TYPE:-i3.xlarge}
        ;;
    gce)
